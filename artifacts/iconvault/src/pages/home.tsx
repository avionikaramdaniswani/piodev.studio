...
import { ArrowRight, Wrench, Download, Code2, PaintBucket, Minimize2, Image as ImageIcon } from "lucide-react";
    ...
    <div className="flex flex-col gap-24 py-8">
      ...
      <section className="text-center max-w-4xl mx-auto flex flex-col items-center">
        <div className="relative inline-block mb-8">
          ...
          <h1 className="relative text-6xl md:text-8xl font-black bg-card px-6 py-4 border-[4px] border-foreground uppercase tracking-tight">
            FREE ICONS. <br/>NO BULLSHIT.
          </h1>
        </div>
        <p className="text-xl md:text-2xl font-medium max-w-2xl mb-12 leading-relaxed">
          The brutalist warehouse for developers. Clean SVGs, zero tracking, and no-nonsense browser tools to get shit done.
        </p>
        <Link href="/icons" className="nb-btn bg-accent text-xl py-4 px-12 inline-flex items-center gap-3">
          BROWSE VAULT <ArrowRight className="w-6 h-6" />
        </Link>
      </section>
      ...
      <section className="w-full">
        <div className="grid grid-cols-2 md:grid-cols-4 border-[4px] border-foreground">
          <div className="bg-primary p-6 border-b-[4px] md:border-b-0 md:border-r-[4px] border-foreground text-center">
            <div className="font-mono text-sm font-bold mb-1">TOTAL ICONS</div>
          ...
          <div className="bg-accent p-6 border-b-[4px] md:border-b-0 md:border-r-[4px] border-foreground text-center">
            <div className="font-mono text-sm font-bold mb-1">DOWNLOADS</div>
          ...
          <div className="bg-[#4DBBFF] p-6 border-r-[4px] border-foreground text-center">
            <div className="font-mono text-sm font-bold mb-1">FREE TOOLS</div>
            <div className="text-4xl font-black">8</div>
          </div>
          <div className="bg-[#00E676] p-6 text-center flex flex-col justify-center">
            <div className="font-mono text-sm font-bold mb-1">PRICE</div>
            <div className="text-4xl font-black">FREE FOREVER</div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="flex justify-between items-end mb-8 border-b-[4px] border-foreground pb-4">
          <h2 className="text-4xl font-black">FEATURED DROPS</h2>
          <Link href="/icons" className="font-bold hover:underline decoration-4 hidden md:block">VIEW ALL →</Link>
        </div>
        ...
        <div className="mt-8 text-center md:hidden">
          <Link href="/icons" className="nb-btn bg-card inline-block">VIEW ALL ICONS →</Link>
        </div>
      </section>
      ...
      <section>
        <div className="flex justify-between items-end mb-8 border-b-[4px] border-foreground pb-4">
          <h2 className="text-4xl font-black">DEV TOOLS</h2>
          <Link href="/tools" className="font-bold hover:underline decoration-4 hidden md:block">ALL TOOLS →</Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="nb-card bg-card flex flex-col h-full group hover:-translate-y-1 transition-transform">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="font-mono text-sm mb-6 flex-1">Strip bloat, remove comments, minify code. Make your SVGs tiny.</p>
              <Link href="/tools/svg-optimizer" className="nb-btn bg-primary w-full text-center mt-auto">USE TOOL →</Link>
            </div>
          </div>
          ...
          <div className="nb-card bg-card flex flex-col h-full group hover:-translate-y-1 transition-transform">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <h3 className="text-2xl font-black mb-2">Color Converter</h3>
              <p className="font-mono text-sm mb-6 flex-1">HEX to RGB to HSL. See contrast ratios instantly.</p>
              <Link href="/tools/color-converter" className="nb-btn bg-accent w-full text-center mt-auto">USE TOOL →</Link>
            </div>
          </div>
          ...
          <div className="nb-card bg-card flex flex-col h-full group hover:-translate-y-1 transition-transform">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <h3 className="text-2xl font-black mb-2">Image Converter</h3>
              <p className="font-mono text-sm mb-6 flex-1">PNG to WebP, JPG to PNG. Browser-side, lightning fast.</p>
              <Link href="/tools/image-converter" className="nb-btn bg-[#4DBBFF] w-full text-center mt-auto">USE TOOL →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-foreground text-background p-12 md:p-20 text-center border-[4px] border-foreground relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-4xl md:text-6xl font-black mb-6 uppercase">STOP SEARCHING.<br/>START BUILDING.</h2>
